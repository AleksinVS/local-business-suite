...
class MemoryAdminObservabilityTests(TestCase):
    ...
    def test_memory_admin_registers_observability_models(self):
        expected_admin_classes = {
            ...
            MemoryFileObject: django_admin.site._registry[MemoryFileObject].__class__,
            MemoryFileObjectVersion: django_admin.site._registry[MemoryFileObjectVersion].__class__,
            MemoryFilePathAlias: django_admin.site._registry[MemoryFilePathAlias].__class__,
            MemoryFilePhysicalPlacement: django_admin.site._registry[MemoryFilePhysicalPlacement].__class__,
            MemoryFileVirtualView: django_admin.site._registry[MemoryFileVirtualView].__class__,
            MemoryFileVirtualRule: django_admin.site._registry[MemoryFileVirtualRule].__class__,
            MemoryFileVirtualPlacement: django_admin.site._registry[MemoryFileVirtualPlacement].__class__,
            MemoryFileUsageEvent: django_admin.site._registry[MemoryFileUsageEvent].__class__,
            MemoryFileOrganizationProposal: django_admin.site._registry[MemoryFileOrganizationProposal].__class__,
            MemoryFileOrganizationDecision: django_admin.site._registry[MemoryFileOrganizationDecision].__class__,
            MemoryFileMoveJob: django_admin.site._registry[MemoryFileMoveJob].__class__,
    ...
    def test_user_virtual_view_ui_does_not_move_file_or_grant_access(self):
        with TemporaryDirectory() as tmpdir:
            ...
            denied = self.client.post(
                reverse("memory:user_file_views"),
