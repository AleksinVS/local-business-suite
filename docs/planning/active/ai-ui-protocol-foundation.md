...
Active planning. Реализация не начата.
...
Статус: выполняется в текущем документационном срезе.
...
- AG-UI и CopilotKit быстро меняются. Нужно фиксировать версии пакетов.
