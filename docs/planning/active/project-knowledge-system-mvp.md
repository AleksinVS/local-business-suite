...
**Проектный документ:** `docs/architecture/project-knowledge-system-v0.1.md` (версия 0.8; далее — «проект»)
...
# и парой «вопрос о решении → её id» для каждой новой страницы pattern/constraint.
# Формат case — ровно эти поля:
