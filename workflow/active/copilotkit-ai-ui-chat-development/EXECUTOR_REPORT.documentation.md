...
- добавлен active planning `docs/planning/active/copilotkit-ai-ui-chat-development.md`;
- создан workflow-блок `workflow/active/copilotkit-ai-ui-chat-development/`;
...
```bash
python -m json.tool workflow/active/copilotkit-ai-ui-chat-development/ARCHITECT_PLAN.json
make gen-struct
