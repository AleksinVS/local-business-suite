...
Статус: исторический gap analysis для состояния на 2026-05-20. Актуальная фактическая MVP-граница описана в `docs/architecture/MEMORY_MVP_CURRENT_STATE.md`.
