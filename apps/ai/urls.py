...
urlpatterns = [
    ...
    path("ui/session/new/", AIUISidebarSessionNewView.as_view(), name="ui_session_new"),
    path("ui/session/clear/", AIUISidebarSessionClearView.as_view(), name="ui_session_clear"),
